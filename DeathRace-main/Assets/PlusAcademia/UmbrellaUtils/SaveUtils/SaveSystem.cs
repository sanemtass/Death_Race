...
namespace UmbrellaUtils.SaveUtils
{
    public static class SaveSystem
    {
        ...
        private static readonly string AssetPath = Application.dataPath + "/UmbrellaUtils/Saves/";

        private static readonly string AssetPathNonerasablePath = Application.dataPath + "/UmbrellaUtils/Saves/Nonerasable/";
       ...
       public static T Load<T>(string name, SaveType saveType, string customPath)
       {
        ...
        public static bool HasSaveFile(string name, SaveType saveType, SavePathType savePathType = SavePathType.Game_Erasable)
        {
